...
var dogeSayings = ['my favorite', 'so beautiful', 'much hotness', 'come at me!', 'skoll!', 'such a player', 'vegas', 'come upstairs?', 'vanilla vodka', 'electric daisies', 'svedska' ,'barley wines', 'cabin in voss', 'vikings and vasa', 'hosptial cuddles', 'love your face', 'kitty loves tiger', 'tiger loves kitty', 'forever tiger', 'forever kitty', 'why not four?', 'best friend' , 'love of my life',]
  ...
  window.requestAnimationFrame(function () {
    ...
    if (metadata.terminated) {
      if (metadata.over) {
        ...
        setTimeout(function(){self.message(true)},3000);
...
HTMLActuator.prototype.message = function (won) {
  var type    = won ? "game-over" : "game-over";
  var message = won ? "You win! Marry your Tiger?" : "You win! Marry your Tiger?";
